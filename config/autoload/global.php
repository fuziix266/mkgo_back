...
return [
    ...
    'db' => [
        'driver' => 'Pdo',
        // Uso de variables de entorno (Compatible con Laravel/Dokploy estándar)
        'dsn' => 'mysql:dbname=' . (getenv('DB_DATABASE') ?: getenv('DB_NAME') ?: 'mkgo') . ';host=' . (getenv('DB_HOST') ?: 'localhost') . ';port=' . (getenv('DB_PORT') ?: '3306') . ';charset=utf8',
